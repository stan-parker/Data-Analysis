# Data-Analysis
A repository for the code used to produce results described in manuscript "Determining the temporal relationships between change in possession and player movement in Australian Football".
